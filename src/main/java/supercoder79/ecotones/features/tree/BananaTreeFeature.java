...
public class BananaTreeFeature extends AbstractTreeFeature<BranchedTreeFeatureConfig> {
    public BananaTreeFeature(Function<Dynamic<?>, ? extends BranchedTreeFeatureConfig> function) {
        super(function);
    }
...
//        System.out.println("Generated at " + "" + pos.getX() + ", " + pos.getY() + ", " + pos.getZ());
    ...
    private void generateTrunk(ModifiableTestableWorld world, Random random, BlockPos.Mutable pos, Set<BlockPos> logs, BlockBox box, BranchedTreeFeatureConfig config) {
        int height = 8;
    ...
    private void generateLeaves(ModifiableTestableWorld world, Random random, BlockPos pos, Set<BlockPos> leaves, BlockBox box, BranchedTreeFeatureConfig config) {
    ...
    private void generateLeafSection(ModifiableTestableWorld world, Random random, BlockPos pos, Set<BlockPos> leaves, BlockBox box, BranchedTreeFeatureConfig config, Direction direction) {
        for (int i = 0; i < 3; i++) {
