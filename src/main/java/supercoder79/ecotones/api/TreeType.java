...
public enum TreeType {
    ...
    MEDIUM_SMALL_RARE_OAK(new TreeGenerationConfig(0.55, Blocks.OAK_LOG.getDefaultState(), Blocks.OAK_LEAVES.getDefaultState(), 4, 5, 8, 5, 0.4, 0.4, false)),
    ...
    DEAD_BIRCH(new TreeGenerationConfig(0.08, Blocks.BIRCH_LOG.getDefaultState(), Blocks.AIR.getDefaultState(), 6, -1, 16, 6, 0.45, 0.45, false)),
    ...
    RARE_DEAD_BIRCH(new TreeGenerationConfig(0.03, Blocks.BIRCH_LOG.getDefaultState(), Blocks.AIR.getDefaultState(), 6, -1, 12, 6, 0.45, 0.45, false)),
