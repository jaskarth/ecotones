...
public class RockFeatureConfig implements FeatureConfig {
    public static final Codec<RockFeatureConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            Codec.INT.fieldOf("start_radius").withDefault(0).forGetter(config -> config.startRadius),
            Codec.BOOL.fieldOf("post_process").withDefault(true).forGetter(config -> config.postProcess)
