...
public class LushDesertBiome extends EcotonesBiomeBuilder {
    ...
    public static void init() {
        INSTANCE = EarlyBiomeRegistry.register(new Identifier("ecotones", "lush_desert"), new LushDesertBiome(0.5f, 0.3f, 2.4, 0.94).build());
        HILLY = EarlyBiomeRegistry.register(new Identifier("ecotones", "lush_desert_hilly"), new LushDesertBiome(1f, 0.5f, 4.2, 0.87).build());
        MOUNTAINOUS = EarlyBiomeRegistry.register(new Identifier("ecotones", "lush_desert_mountainous"), new LushDesertBiome(1.75f, 0.8f, 8, 0.81).build());
