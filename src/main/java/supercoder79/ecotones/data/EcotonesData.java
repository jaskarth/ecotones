...
public class EcotonesData {
    public static final Identifier SOIL_QUALITY = new Identifier("ecotones", "soil_quality");
    public static final Identifier SOIL_DRAINAGE = new Identifier("ecotones", "soil_drainage");
