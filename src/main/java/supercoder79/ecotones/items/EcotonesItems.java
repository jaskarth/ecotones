...
//    public static final Item EXCURSION_FUNNEL = new BlockItem(EcotonesBlocks.EXCURSION_FUNNEL, new Item.Settings().group(EcotonesItemGroups.ECOTONES));
//    public static final Item SULFUR_ORE = new BlockItem(EcotonesBlocks.SULFUR_ORE, new Item.Settings().group(EcotonesItemGroups.ECOTONES));
...
//        register("sulfur_ore", SULFUR_ORE);
