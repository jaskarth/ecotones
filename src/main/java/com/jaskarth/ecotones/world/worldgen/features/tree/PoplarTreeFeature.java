...
import com.jaskarth.ecotones.world.worldgen.tree.trait.poplar.PoplarTrait;
import com.jaskarth.ecotones.world.worldgen.tree.trait.poplar.DefaultPoplarTrait;
...
public class PoplarTreeFeature extends EcotonesFeature<SimpleTreeFeatureConfig> {
    ...
    public boolean generate(FeatureContext<SimpleTreeFeatureConfig> context) {
        ...
        for (int y = 0; y < leafHeight; y++) {
            FeatureHelper.circle(mutable.mutableCopy(), maxRadius * trait.model(y / leafRadius), leafPos -> {
